...
public class EditarDniPaciente extends javax.swing.JFrame {

    private Consultorio consultorio;

    private Paciente paciente;

    public EditarDniPaciente(Consultorio consultorio, Paciente paciente) {
        initComponents();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            ...
            if (respuesta == 0) {
                ...
                consultorio.encontrarDniDePacienteExistente(txtDni);
            ...
            JOptionPane.showMessageDialog(null, "El Dni Del Paciente Se Ha Modificado Con Exito");
            this.dispose();
